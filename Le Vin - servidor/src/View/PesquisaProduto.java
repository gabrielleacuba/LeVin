...
public class PesquisaProduto extends javax.swing.JDialog {
    public static CadastroPedido paiPedidoProduto;
     ...
     */
    public PesquisaProduto(CadastroPedido parent, boolean modal) {
        //super(parent, modal);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaProduto dialog = new PesquisaProduto(paiPedidoProduto, true);
