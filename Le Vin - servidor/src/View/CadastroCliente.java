...
public class CadastroCliente extends javax.swing.JInternalFrame {
    ...
    public static BuscarEnderecoCadastro filhoBusca;
    ...
    private void adicionar_clientes() {
        String sql = "insert into clientes (Nome,DataNascimento,telefone,celular,telefoneRecado,sexo,email,cep,endereco,bairro,numero,cidade,uf,complemento,rg,cpf_cnpj,enderecoEntrega,cepEntrega,bairroEntrega,cidadeEntrega,ufEntrega,numeroEntrega,complementoEntrega) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try {
            ...
            pst.setString(5, telRecadosCliente.getText());
            ...
            if (NomeCliente.getText().isEmpty() || numeroCliente.getText().isEmpty()) {
                ...
                if (aux > 0) {
                    ...
                    telRecadosCliente.setText(null);
                    ...
                    enderecoClienteEntrega.setText(null);
                    ...
                    JOptionPane.showMessageDialog(null, "Nao foi possivel adicionar o cliente");
                }
            }
        } catch (Exception e) {
    ...
    //Classe que busca o endereço do cliente através do cep
    private void BuscarCep() {
        ...
        try {
            ...
            enderecoCliente.setText(viacep.getLogradouro().toString());
            ...
            JOptionPane.showMessageDialog(null, "Nao foi possivel localizar cep");
        }
    }

    public void BuscarEndereco(String Endereco, String Cidade, String Uf) {
    ...
    private void BuscarCepEntrega() {
        ...
        try {
            ...
            enderecoClienteEntrega.setText(viacep.getLogradouro().toString());
            bairroClienteEntrega.setText(viacep.getBairro());
    ...
    private void initComponents() {
        ...
        telRecadosCliente = new javax.swing.JTextField();
        ...
        setClosable(true);
        setTitle("Le Vin - Tela Cadastro Clientes");
        setName(""); // NOI18N
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(telRecadosCliente, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(41, 41, 41))
                    .addGroup(jPanel2Layout.createSequentialGroup()
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(9, 9, 9)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(telRecadosCliente, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel7)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnEnderecoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEnderecoActionPerformed
        filhoBusca = new BuscarEnderecoCadastro(this, true);
    ...
    private javax.swing.JTextField telRecadosCliente;
