...
public class buscaEndereco extends javax.swing.JDialog {
    public static AlterarCliente buscaEndereco;
    /**
     * Creates new form buscaEndereco
     */
    public buscaEndereco(AlterarCliente parent, boolean modal) {
        //super(parent, modal);
        this.buscaEndereco = parent;
        this.setModal(modal);
    ...
    private void Endereco(){
        ...
        if(buscarEndereco.getText().isEmpty()||buscarCidade.getText().isEmpty()||buscarUf.getText().isEmpty()){
            ...
            buscaEndereco.RecebeEndereco(endereco, Cidade, Uf);
            dispose();            
        }
    ...
    private void initComponents() {
        ...
        setTitle("Le vin - Busca Endereco");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buscaEndereco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                buscaEndereco dialog = new buscaEndereco(buscaEndereco, true);
